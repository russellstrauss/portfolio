...
# Stash any uncommitted changes (node_modules should be in .gitignore, so won't be stashed)
...
if ($LASTEXITCODE -ne 0) {
    ...
    # First, clean any untracked files that might conflict (excluding node_modules)
