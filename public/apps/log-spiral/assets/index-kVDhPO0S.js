...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Ua(){return new Ln({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:un,depthTest:!1,depthWrite:!1})}function Ia(){return new Ln({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xs(),fragmentShader:`
...
`].filter(Zn).join(`
`)),o=hs(o),o=ka(o,t),o=Wa(o,t),a=hs(a),a=ka(a,t),a=Wa(a,t),o=Xa(o),a=Xa(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
