...
// Removing items from dashboard
function remove_menus () {
	global $menu;
	$restricted = array(__('Posts'), __('Links'), __('Users'), __('Comments'));
	end ($menu);
	while (prev($menu)){
...
// Give portfolio pieces category support
add_action( 'init', 'add_category_support' );
function add_category_support() {
	//register_taxonomy_for_object_type('category', 'portfolio-piece');
}
