...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<div class="portfolio-category container-fluid">
						...
						<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
							...
							<?php while ($my_query2->have_posts()) : $my_query2->the_post(); ?>
								...
								<?php
									...
									<?php if (($page_title_url == 'web-development' || $page_title_url == 'computer-graphics' || $page_title_url == 'fragments') && get_field('external-link') != null) {
									...
									<?php		
										...
										if (get_field('unfinished')) { ?>
											...
											<div class="piece-details">
												...
												<h2><a class="unfinished"><?php the_title(); ?> </a></h2>
												<p><?php the_field('description'); ?></p>
											</div> 
										<?php
										} 
